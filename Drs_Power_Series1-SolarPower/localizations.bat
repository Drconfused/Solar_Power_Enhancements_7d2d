...
:confirmed
color 0C                                                                                                         
echo	Power Series 1 - Solar Power               
echo.
pause
echo.                                                                       
echo.
for %%I in (.) do set CurrDirName=%%~nxI
echo This will load up the localization data for the mod "Power Series 1 - Solar Power".
echo.
...
FINDSTR /v "solarbank_ solarCell_ purifiedSili --Drconfused_Power_Series1_Solar" LocalizationTEMP.txt > "../../data/config/Localization.txt"
